...
.field public final synthetic A03:LX/2nl;
...
.method public constructor <init>(LX/2nl;)V
    ...
    iput-object p1, p0, LX/39p;->A03:LX/2nl;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iget-object v0, p1, LX/2nl;->A00:LX/4Mb;
    ...
    iput-object v4, p0, LX/39p;->A01:Ljava/io/OutputStream;

    iget-object v0, p1, LX/2nl;->A00:LX/4Mb;

    invoke-virtual {v0, v4}, LX/4Mb;->A02(Ljava/io/OutputStream;)V

    iget-object v3, p1, LX/1eC;->A04:LX/0wx;

    invoke-virtual {p1}, LX/2nl;->A0B()LX/0py;
    ...
    invoke-virtual {v3, v2, v4, v1, v0}, LX/0wx;->A04(LX/0py;Ljava/io/OutputStream;[B[B)Ljava/util/zip/ZipOutputStream;

    move-result-object v0

    iput-object v0, p0, LX/39p;->A02:Ljava/util/zip/ZipOutputStream;
...
.method public Agh(Ljava/io/File;)V
    ...
    :try_start_0
    iget-object v1, p0, LX/39p;->A02:Ljava/util/zip/ZipOutputStream;
...
.method public Agj(LX/02q;LX/1M8;Ljava/io/File;Ljava/lang/String;J)V
    ...
    :try_start_0
    iget-object v3, p0, LX/39p;->A02:Ljava/util/zip/ZipOutputStream;
...
.method public close()V
    ...
    iget-boolean v0, p0, LX/39p;->A00:Z

    if-nez v0, :cond_0

    iget-object v0, p0, LX/39p;->A02:Ljava/util/zip/ZipOutputStream;

    invoke-virtual {v0}, Ljava/io/OutputStream;->close()V

    iget-object v0, p0, LX/39p;->A01:Ljava/io/OutputStream;

    invoke-virtual {v0}, Ljava/io/OutputStream;->close()V

    const/4 v0, 0x1

    iput-boolean v0, p0, LX/39p;->A00:Z
