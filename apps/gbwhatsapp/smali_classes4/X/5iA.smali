...
.method public constructor <init>(LX/18Z;LX/0q4;)V
    ...
    iput-object v0, p0, LX/5iA;->A04:Ljava/util/Map;

    iput-object p1, p0, LX/5iA;->A01:LX/18Z;

    iput-object p2, p0, LX/5iA;->A02:LX/0q4;

    iput-object v1, p0, LX/5iA;->A03:Ljava/security/cert/X509Certificate;
...
.method public final declared-synchronized A00()Landroid/content/SharedPreferences;
    ...
    :try_start_0
    iget-object v0, p0, LX/5iA;->A00:Landroid/content/SharedPreferences;

    if-nez v0, :cond_0

    iget-object v1, p0, LX/5iA;->A02:LX/0q4;

    const-string v0, "novi.certificate"

    invoke-virtual {v1, v0}, LX/0q4;->A00(Ljava/lang/String;)Landroid/content/SharedPreferences;

    move-result-object v0

    iput-object v0, p0, LX/5iA;->A00:Landroid/content/SharedPreferences;
...
.method public A01(Ljava/lang/String;)LX/5en;
    .locals 11

    iget-object v4, p0, LX/5iA;->A04:Ljava/util/Map;
    ...
    :cond_0
    iget-object v8, p0, LX/5iA;->A03:Ljava/security/cert/X509Certificate;
    ...
    invoke-virtual {p0}, LX/5iA;->A00()Landroid/content/SharedPreferences;
    ...
    :cond_1
    iget-object v6, p0, LX/5iA;->A01:LX/18Z;

    new-instance v5, LX/5jY;

    invoke-direct/range {v5 .. v10}, LX/5jY;-><init>(LX/18Z;Ljava/lang/String;Ljava/security/cert/X509Certificate;Ljava/util/Date;Ljava/util/List;)V
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
    .catch LX/5a5; {:try_start_0 .. :try_end_0} :catch_0

    iget-object v0, v5, LX/5jY;->A01:LX/5en;
    ...
    :catch_0
    const-string v0, "Can\'t retrieve the certificate path"
