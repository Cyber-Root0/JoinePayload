...
.method public constructor <init>(LX/5mM;LX/5mM;)V
    ...
    iput-object p1, p0, LX/5q5;->A03:LX/5mM;

    iput-object p2, p0, LX/5q5;->A02:LX/5mM;

    iget-object v0, p1, LX/5mM;->A00:LX/1aF;

    iput-object v0, p0, LX/5q5;->A01:LX/1aF;

    iget-object v0, p2, LX/5mM;->A00:LX/1aF;

    iput-object v0, p0, LX/5q5;->A00:LX/1aF;
...
.method public A8K(LX/5sQ;LX/5mV;I)LX/5sQ;
    ...
    iget-object v0, p0, LX/5q5;->A00:LX/1aF;
    ...
    iget-object v0, p0, LX/5q5;->A02:LX/5mM;
    ...
    iget-object v0, p0, LX/5q5;->A03:LX/5mM;

    iget-object v0, v0, LX/5mM;->A02:LX/1aF;

    new-instance v3, LX/5ep;

    invoke-direct {v3, v0, v1, v5, v2}, LX/5ep;-><init>(LX/1aF;Ljava/math/BigDecimal;IZ)V

    :goto_1
    invoke-virtual {v4, v3}, LX/5sQ;->A07(LX/5ep;)LX/5sQ;
    ...
    iget-object v3, p0, LX/5q5;->A03:LX/5mM;

    iget-object v0, v3, LX/5mM;->A02:LX/1aF;

    invoke-static {v0, v4, v1, v5}, LX/5ep;->A00(LX/1aF;LX/5sQ;Ljava/math/BigDecimal;Z)LX/5sQ;
    ...
    invoke-direct {v3, v0, v1, v2, v2}, LX/5ep;-><init>(LX/1aF;Ljava/math/BigDecimal;IZ)V
    ...
    invoke-static {p1, v0, v1, v5, v2}, LX/5ep;->A01(LX/5sQ;LX/5mM;Ljava/math/BigDecimal;IZ)LX/5sQ;
    ...
    iget-object v4, p0, LX/5q5;->A02:LX/5mM;

    invoke-static {p1, v4, v1, v2, v0}, LX/5ep;->A01(LX/5sQ;LX/5mM;Ljava/math/BigDecimal;IZ)LX/5sQ;
    ...
    invoke-static {v0, v3, v1, v2}, LX/5ep;->A00(LX/1aF;LX/5sQ;Ljava/math/BigDecimal;Z)LX/5sQ;
...
.method public AG4(Landroid/content/Context;LX/018;LX/5mV;)Ljava/lang/CharSequence;
    ...
    invoke-direct {v0, v1, v7}, Ljava/math/MathContext;-><init>(ILjava/math/RoundingMode;)V
...
.method public AJ6(LX/5mV;)Z
    ...
    iget-object v0, p0, LX/5q5;->A01:LX/1aF;
    ...
    iget-object v0, v0, LX/5md;->A03:Ljava/lang/String;
