.class public final Lcom/cow/inject/ApkUtil;
...
.method public static findApkSigningBlock(Ljava/nio/channels/FileChannel;)Lcom/cow/inject/Pair;
    .locals 2
    ...
    invoke-static {p0}, Lcom/cow/inject/ApkUtil;->findCentralDirStartOffset(Ljava/nio/channels/FileChannel;)J

    move-result-wide v0

    invoke-static {p0, v0, v1}, Lcom/cow/inject/ApkUtil;->findApkSigningBlock(Ljava/nio/channels/FileChannel;J)Lcom/cow/inject/Pair;
...
.method public static findApkSigningBlock(Ljava/nio/channels/FileChannel;J)Lcom/cow/inject/Pair;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, p0}, Lcom/cow/inject/Pair;->of(Ljava/lang/Object;Ljava/lang/Object;)Lcom/cow/inject/Pair;
    ...
    :cond_0
    new-instance p0, Lcom/cow/inject/SignatureNotFoundException;
    ...
    invoke-direct {p0, p1}, Lcom/cow/inject/SignatureNotFoundException;-><init>(Ljava/lang/String;)V
...
.method public static findCentralDirStartOffset(Ljava/nio/channels/FileChannel;)J
    ...
    invoke-static {p0}, Lcom/cow/inject/ApkUtil;->getCommentLength(Ljava/nio/channels/FileChannel;)J

    move-result-wide v0

    invoke-static {p0, v0, v1}, Lcom/cow/inject/ApkUtil;->findCentralDirStartOffset(Ljava/nio/channels/FileChannel;J)J
...
.method public static findIdValues(Ljava/nio/ByteBuffer;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lcom/cow/inject/ApkUtil;->checkByteOrderLittleEndian(Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {p0, v1, v0}, Lcom/cow/inject/ApkUtil;->sliceFromTo(Ljava/nio/ByteBuffer;II)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0, v4}, Lcom/cow/inject/ApkUtil;->getByteBuffer(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
    ...
    :cond_0
    new-instance v0, Lcom/cow/inject/SignatureNotFoundException;
    ...
    invoke-direct {v0, p0}, Lcom/cow/inject/SignatureNotFoundException;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0}, Lcom/cow/inject/SignatureNotFoundException;-><init>(Ljava/lang/String;)V
...
.method public static hasV2SignBlock(Ljava/io/File;)Z
    ...
    :try_end_0
    .catch Lcom/cow/inject/SignatureNotFoundException; {:try_start_0 .. :try_end_0} :catch_1
    ...
    invoke-static {v1}, Lcom/cow/inject/ApkUtil;->getCommentLength(Ljava/nio/channels/FileChannel;)J

    move-result-wide v3

    invoke-static {v1, v3, v4}, Lcom/cow/inject/ApkUtil;->findCentralDirStartOffset(Ljava/nio/channels/FileChannel;J)J

    move-result-wide v3

    invoke-static {v1, v3, v4}, Lcom/cow/inject/ApkUtil;->findApkSigningBlock(Ljava/nio/channels/FileChannel;J)Lcom/cow/inject/Pair;

    move-result-object p0

    invoke-virtual {p0}, Lcom/cow/inject/Pair;->getFirst()Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Ljava/nio/ByteBuffer;

    invoke-static {p0}, Lcom/cow/inject/ApkUtil;->findIdValues(Ljava/nio/ByteBuffer;)Ljava/util/Map;
    ...
    check-cast p0, Ljava/nio/ByteBuffer;
    :try_end_1
    .catch Lcom/cow/inject/SignatureNotFoundException; {:try_start_1 .. :try_end_1} :catch_0
