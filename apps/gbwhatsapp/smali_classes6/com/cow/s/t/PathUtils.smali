.class public Lcom/cow/s/t/PathUtils;
...
.field public static final TAG:Ljava/lang/String; = "PathUtils2"
...
.method public static generateFileName(Ljava/lang/String;Ljava/io/File;)Ljava/io/File;
    ...
    :cond_3
    invoke-static {p1}, Lcom/cow/s/t/PathUtils;->logDir(Ljava/io/File;)V
    ...
    const-string p1, "PathUtils2"

    invoke-static {p1, p0}, Lcom/cow/s/u/Logger;->w(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static getDocumentCacheDir(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-static {p0}, Lcom/cow/s/t/PathUtils;->logDir(Ljava/io/File;)V

    invoke-static {v0}, Lcom/cow/s/t/PathUtils;->logDir(Ljava/io/File;)V
...
.method public static getFile(Landroid/content/Context;Landroid/net/Uri;)Ljava/io/File;
    ...
    invoke-static {p0, p1}, Lcom/cow/s/t/PathUtils;->getPath(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-static {p0}, Lcom/cow/s/t/PathUtils;->isLocal(Ljava/lang/String;)Z
...
.method public static getFileName(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/cow/s/t/PathUtils;->getName(Ljava/lang/String;)Ljava/lang/String;
...
.method private static getLocalPath(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    const-string v1, "PathUtils2 File -"
    ...
    invoke-static {p1}, Lcom/cow/s/t/PathUtils;->isLocalStorageDocument(Landroid/net/Uri;)Z
    ...
    :cond_1
    invoke-static {p1}, Lcom/cow/s/t/PathUtils;->isExternalStorageDocument(Landroid/net/Uri;)Z
    ...
    :cond_3
    invoke-static {p1}, Lcom/cow/s/t/PathUtils;->isDownloadsDocument(Landroid/net/Uri;)Z
    ...
    :try_start_0
    invoke-static {p0, v5, v3, v3}, Lcom/cow/s/t/PathUtils;->getDataColumn(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_6
    invoke-static {p0, p1}, Lcom/cow/s/t/PathUtils;->getFileName(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;

    move-result-object v0

    invoke-static {p0}, Lcom/cow/s/t/PathUtils;->getDocumentCacheDir(Landroid/content/Context;)Ljava/io/File;

    move-result-object v1

    invoke-static {v0, v1}, Lcom/cow/s/t/PathUtils;->generateFileName(Ljava/lang/String;Ljava/io/File;)Ljava/io/File;
    ...
    invoke-static {p0, p1, v3}, Lcom/cow/s/t/PathUtils;->saveFileFromUri(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;)V

    :cond_7
    return-object v3

    :cond_8
    invoke-static {p1}, Lcom/cow/s/t/PathUtils;->isMediaDocument(Landroid/net/Uri;)Z
    ...
    invoke-static {p0, v3, p1, v0}, Lcom/cow/s/t/PathUtils;->getDataColumn(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_c
    invoke-static {p1}, Lcom/cow/s/t/PathUtils;->isGoogleDriveUri(Landroid/net/Uri;)Z

    move-result v0

    if-eqz v0, :cond_11

    invoke-static {p1, p0}, Lcom/cow/s/t/PathUtils;->getGoogleDriveFilePath(Landroid/net/Uri;Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p1}, Lcom/cow/s/t/PathUtils;->isGooglePhotosUri(Landroid/net/Uri;)Z
    ...
    :cond_f
    invoke-static {p0, p1, v3, v3}, Lcom/cow/s/t/PathUtils;->getDataColumn(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
...
.method public static getMimeType(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/cow/s/t/PathUtils;->getMimeType(Ljava/io/File;)Ljava/lang/String;
...
.method public static getMimeType(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/cow/s/t/PathUtils;->getExtension(Ljava/lang/String;)Ljava/lang/String;
...
.method public static getPath(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lcom/cow/s/t/PathUtils;->getLocalPath(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
...
.method private static logDir(Ljava/io/File;)V
    ...
    invoke-static {v1, v3}, Lcom/cow/s/u/Logger;->d(Ljava/lang/String;Ljava/lang/String;)V
