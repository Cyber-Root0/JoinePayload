.class public Lcom/github/base/core/scheduler/TaskScheduler;
.super Ljava/lang/Object;
.source "TaskScheduler.java"

# interfaces
.implements Lcom/github/base/core/scheduler/ITaskScheduler;
.implements Lcom/github/base/core/scheduler/ITaskProgressEventSink;
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/github/base/core/scheduler/TaskScheduler;->mTaskExecutor:Lcom/github/base/core/scheduler/ITaskExecutor;

    iput-object v0, p0, Lcom/github/base/core/scheduler/TaskScheduler;->mTaskQueue:Lcom/github/base/core/scheduler/ITaskQueue;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lcom/github/base/core/scheduler/TaskScheduler;->mListeners:Ljava/util/List;

    iput-object p1, p0, Lcom/github/base/core/scheduler/TaskScheduler;->mSchedulerName:Ljava/lang/String;

    return-void
.end method

.method private fireOnCompleted(Lcom/github/base/core/scheduler/Task;I)V
    .locals 4
    .param p1, "task"    # Lcom/github/base/core/scheduler/Task;
    .param p2, "hint"    # I

    iget-object v0, p0, Lcom/github/base/core/scheduler/TaskScheduler;->mListeners:Ljava/util/List;
...
.method private fireOnError(Lcom/github/base/core/scheduler/Task;Ljava/lang/Exception;)Z
    .locals 5
    .param p1, "task"    # Lcom/github/base/core/scheduler/Task;
    ...
    .local v0, "retry":Z
    iget-object v1, p0, Lcom/github/base/core/scheduler/TaskScheduler;->mListeners:Ljava/util/List;
...
.method private fireOnPrepare(Lcom/github/base/core/scheduler/Task;)Z
    .locals 5
    .param p1, "task"    # Lcom/github/base/core/scheduler/Task;
...
.method private fireOnProgress(Lcom/github/base/core/scheduler/Task;JJ)V
    .locals 8
    .param p1, "task"    # Lcom/github/base/core/scheduler/Task;
    .param p2, "total"    # J
    ...
    :cond_0
    iget-object v0, p0, Lcom/github/base/core/scheduler/TaskScheduler;->mTaskQueue:Lcom/github/base/core/scheduler/ITaskQueue;
    ...
    invoke-virtual {p0}, Lcom/github/base/core/scheduler/TaskScheduler;->schedule()V
...
.method protected final executeTask(Lcom/github/base/core/scheduler/Task;)Z
    ...
    .local v2, "hasError":Z
    :try_start_0
    invoke-direct {p0, p1}, Lcom/github/base/core/scheduler/TaskScheduler;->fireOnPrepare(Lcom/github/base/core/scheduler/Task;)Z
    ...
    :cond_0
    iget-object v2, p0, Lcom/github/base/core/scheduler/TaskScheduler;->mTaskQueue:Lcom/github/base/core/scheduler/ITaskQueue;
    ...
    iget-object v6, p0, Lcom/github/base/core/scheduler/TaskScheduler;->mTaskExecutor:Lcom/github/base/core/scheduler/ITaskExecutor;
    ...
    invoke-direct {p0, p1, v5}, Lcom/github/base/core/scheduler/TaskScheduler;->fireOnCompleted(Lcom/github/base/core/scheduler/Task;I)V
    :try_end_1
    ...
    :try_start_2
    invoke-direct {p0, p1, v3}, Lcom/github/base/core/scheduler/TaskScheduler;->fireOnError(Lcom/github/base/core/scheduler/Task;Ljava/lang/Exception;)Z
    ...
    :cond_c
    iget-object v3, p0, Lcom/github/base/core/scheduler/TaskScheduler;->mTaskQueue:Lcom/github/base/core/scheduler/ITaskQueue;
...
.method public final onTaskProgressMade(Lcom/github/base/core/scheduler/Task;JJ)V
    .locals 0
    .param p1, "task"    # Lcom/github/base/core/scheduler/Task;
    .param p2, "total"    # J
    .param p4, "completed"    # J

    invoke-direct/range {p0 .. p5}, Lcom/github/base/core/scheduler/TaskScheduler;->fireOnProgress(Lcom/github/base/core/scheduler/Task;JJ)V
...
.method protected final schedule()V
    ...
    new-instance v3, Lcom/github/base/core/scheduler/TaskScheduler$1;

    iget-object v4, p0, Lcom/github/base/core/scheduler/TaskScheduler;->mSchedulerName:Ljava/lang/String;

    invoke-direct {v3, p0, v4, v2}, Lcom/github/base/core/scheduler/TaskScheduler$1;-><init>(Lcom/github/base/core/scheduler/TaskScheduler;Ljava/lang/String;Lcom/github/base/core/scheduler/Task;)V
...
.method protected final setTaskExecutor(Lcom/github/base/core/scheduler/ITaskExecutor;)V
    ...
    iput-object p1, p0, Lcom/github/base/core/scheduler/TaskScheduler;->mTaskExecutor:Lcom/github/base/core/scheduler/ITaskExecutor;
...
.method protected final setTaskQueue(Lcom/github/base/core/scheduler/ITaskQueue;)V
    ...
    iput-object p1, p0, Lcom/github/base/core/scheduler/TaskScheduler;->mTaskQueue:Lcom/github/base/core/scheduler/ITaskQueue;
