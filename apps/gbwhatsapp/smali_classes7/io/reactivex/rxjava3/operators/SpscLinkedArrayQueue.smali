...
.method public offer(Ljava/lang/Object;)Z
    ...
    iget-object v2, p0, Lio/reactivex/rxjava3/operators/SpscLinkedArrayQueue;->producerBuffer:Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    invoke-static {v4, v5, v0}, Lio/reactivex/rxjava3/operators/SpscLinkedArrayQueue;->calcWrappedOffset(JI)I
    ...
    invoke-direct/range {v1 .. v6}, Lio/reactivex/rxjava3/operators/SpscLinkedArrayQueue;->writeToQueue(Ljava/util/concurrent/atomic/AtomicReferenceArray;Ljava/lang/Object;JI)Z
    ...
    :cond_0
    iget v1, p0, Lio/reactivex/rxjava3/operators/SpscLinkedArrayQueue;->producerLookAheadStep:I

    int-to-long v7, v1

    add-long/2addr v7, v4

    invoke-static {v7, v8, v0}, Lio/reactivex/rxjava3/operators/SpscLinkedArrayQueue;->calcWrappedOffset(JI)I

    move-result v1

    invoke-static {v2, v1}, Lio/reactivex/rxjava3/operators/SpscLinkedArrayQueue;->lvElement(Ljava/util/concurrent/atomic/AtomicReferenceArray;I)Ljava/lang/Object;
    ...
    iput-wide v7, p0, Lio/reactivex/rxjava3/operators/SpscLinkedArrayQueue;->producerLookAhead:J
    ...
    invoke-static {v9, v10, v0}, Lio/reactivex/rxjava3/operators/SpscLinkedArrayQueue;->calcWrappedOffset(JI)I
    ...
    invoke-direct/range {v1 .. v8}, Lio/reactivex/rxjava3/operators/SpscLinkedArrayQueue;->resize(Ljava/util/concurrent/atomic/AtomicReferenceArray;JILjava/lang/Object;J)V
